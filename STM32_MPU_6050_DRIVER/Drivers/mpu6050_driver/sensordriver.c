...
uint16_t bytesToUint16_LittleEndian(uint8_t *pdata);//most significant bit is on the top of right
uint16_t bytesToUint16_BigEndian(uint8_t *pdata); //most significant bit is on the top of left
